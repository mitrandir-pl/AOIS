class LogicFunction:
    ...
    def check(self, formula):
        ...
        for index in range(len(formula)):
            if formula[index] == "(":
                test_2 = True if formula[index+1] == "a" or formula[index+1] == "b" or formula[index+1] == "c" or formula[index+1] == "!" or formula[index+1] == "(" else False
            elif index+1 < len(formula) and formula[index] == "a":
                test_3 = True if formula[index+1] == ")" or formula[index+1] == "+" or  formula[index+1] == "*" else False
            elif index+1 < len(formula) and formula[index] == "b":
                test_4 = True if formula[index+1] == ")" or formula[index+1] == "+" or  formula[index+1] == "*" else False
            elif index+1 < len(formula) and formula[index] == "c":
                test_5 = True if formula[index+1] == ")" or formula[index+1] == "+" or  formula[index+1] == "*" else False
            elif formula[index] == "!":
                test_6 = True if formula[index+1] == "a" or formula[index+1] == "b" or formula[index+1] == "c" or formula[index+1] == "(" or formula[index+1] == "!" else False
            elif formula[index] == "+":
                test_7 = True if formula[index+1] == "a" or formula[index+1] == "b" or formula[index+1] == "c" or formula[index+1] == "(" or formula[index+1] == "!" else False
            elif formula[index] == "*":
                test_8 = True if formula[index+1] == "a" or formula[index+1] == "b" or formula[index+1] == "c" or formula[index+1] == "(" or formula[index+1] == "!" else False
            if index+1 < len(formula) and formula[index] == ")":
                test_9 = True if formula[index+1] == ")" or formula[index+1] == "+" or formula[index+1] == "*" else False
